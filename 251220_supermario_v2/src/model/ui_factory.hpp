	...
	class UIFactory {
		...
		public:
			...
			virtual void create_enemy(
				const Coord& top_left, const int width, const int height) = 0;			virtual void create_flying_enemy(
				const Coord& top_left, const int width, const int height) = 0;			virtual void create_jumping_enemy(
				const Coord& top_left, const int width, const int height) = 0;
